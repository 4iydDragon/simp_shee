 ...
 * If the user types the command exit, the program
 *exits without executing any command.
 * If the user types the command env, the program prints
 *the current environment.
*/

int main(void)
{char input[1024], char *command, char *args[10], int i, char *path;
int status;
while (1)
{printf("#cisfun$ ");
