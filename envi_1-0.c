 ...
 * If the user types the command exit, the program exits without executing any command.
 * If the user types the command env, the program prints the current environment.
*/
